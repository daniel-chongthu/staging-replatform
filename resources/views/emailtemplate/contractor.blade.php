...
<h1 style="margin:0 0 16px">Contractors</h1>
...
<table style="bprder:1px solid #000">
    ...
    <tr><th>Contact Email : </th><td>{{$contact_email}}</td></tr>
    <tr><th>Trade Services: </th><td>{{$trade_services}}</td></tr>
    <tr><th>Service Areas: </th><td>{{$service_areas}}</td></tr>
    <tr><th>Others: </th><td>{{$other}}</td></tr>
