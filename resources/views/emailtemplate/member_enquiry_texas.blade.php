...
<table style="bprder:1px solid #000">
    <tr><th>Location Name : </th><td>{{$location_name_4}}</td></tr>
    <tr><th>Name : </th><td>{{$first_name_4.' '.$last_name_4}}</td></tr>
    <tr><th>State : </th><td>{{$state_4}}</td></tr>
    <tr><th>Email : </th><td>{{$email_4}}</td></tr>
    <tr><th>Phone Number : </th><td>{{$phone_number_4}}</td></tr>
    <tr><th>Information Message : </th><td>{{$information_4}}</td></tr>
